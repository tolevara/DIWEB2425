...
if(isset($_REQUEST['elegir'])) { //SI SE ENVIA EL FORMULARIO ENTONCES HACEMOS...//
    ...
    switch ($opcion) {  //PARA PASAR A OTRA PAGINA SE USA header(); //
        ...
        case 'ej3': header('Location: Ex1306-anidi.php');      break;
        case 'ej4': header('Location: Ex1306-medioGeom.php'); break;
        case 'ej5': header('Location: Ex1306-biblioteca.php');         break;
